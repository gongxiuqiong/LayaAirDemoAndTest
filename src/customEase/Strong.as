 ...
 **/
	final public class Strong {
		...
		public static var easeOut:CustomEase = new CustomEase(1,4);
		
		/** Eases in with a power of 4 **/
		public static var easeIn:CustomEase = new CustomEase(2,4);
		
		/** Eases in and then out with a power of 4 **/
		public static var easeInOut:CustomEase = new CustomEase(3,4);
