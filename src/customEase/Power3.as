 ...
 **/
	final public class Power3 {
		...
		public static var easeOut:CustomEase = new CustomEase(1,3);
		
		/** Eases in with a power of 3 **/
		public static var easeIn:CustomEase = new CustomEase(2,3);
		
		/** Eases in and then out with a power of 3 **/
		public static var easeInOut:CustomEase = new CustomEase(3,3);
	}
}