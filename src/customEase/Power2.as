 ...
 **/
	final public class Power2 {
		...
		public static var easeOut:CustomEase = new CustomEase(1,2);
		
		/** Eases in with a power of 2 **/
		public static var easeIn:CustomEase = new CustomEase(2,2);
		
		/** Eases in and then out with a power of 2 **/
		public static var easeInOut:CustomEase = new CustomEase(3,2);
	}
}