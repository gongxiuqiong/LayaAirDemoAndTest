 ...
 */	 
	public class RoughEase extends CustomEase {
		...
		public function RoughEase(vars:*=null, ...args) {
			...
			var taper:String = vars.taper || "none",
				...
				template:CustomEase = (vars.template is CustomEase) ? vars.template : null,
		 ...
		 */
		public static function create(strength:Number=1, points:uint=20, clamp:Boolean=false, templateEase:CustomEase=null, taper:String="none", randomize:Boolean=true, name:String=""):CustomEase {
		 ...
		 */
		public static function byName(name:String):CustomEase {
			return _lookup[name];
		}
