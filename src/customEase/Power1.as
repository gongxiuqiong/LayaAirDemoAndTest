 ...
 **/
	final public class Power1 {
		...
		public static var easeOut:CustomEase = new CustomEase(1,1);
		
		/** Eases in with a power of 1 **/
		public static var easeIn:CustomEase = new CustomEase(2,1);
		
		/** Eases in and then out with a power of 1 **/
		public static var easeInOut:CustomEase = new CustomEase(3,1);
	}
}