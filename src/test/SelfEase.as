...
//			return -c * (t /= d) * (t - 2) + b;
		...
		private static function getRatio(t:Number, d:Number, $type:int, $power:int):Number {
			var p:Number = t/d;
